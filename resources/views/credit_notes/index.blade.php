            ...
            <div class="card-body">
                <div id="wrapper">
                    ...
                    >
                        ...
                        <form method="GET" action="/credit_notes">
                            @csrf
                        ...
                        <p>Want to record a new credit note? Click <a href="{{ url('/credit_notes/create') }}">here</a>!</p>
                        <p></p>
                        ...
                        @forelse ($creditNotes as $creditNote)
                            <div id="content">
                                <div id="title">
                                    ...
                                    <div style="display:inline-block;"><button class="btn btn-link" onclick="location.href = '/credit_notes/{{ $creditNote->id }}/edit';">Edit</button></div>
                                    <div style="display:inline-block;"><form method="POST" action="/credit_notes/{{ $creditNote->id }}">
                                        @csrf
                                        @method('DELETE')
