            ...
            <div class="card-body">
                <div id="wrapper">
                    ...
                    >
                        ...
                        <form method="GET" action="/supplier_credits">
                            @csrf
                        ...
                        <p>Want to record a new supplier credit? Click <a href="{{ url('/supplier_credits/create') }}">here</a>!</p>
                        <p></p>
                        ...
                        @forelse ($supplierCredits as $supplierCredit)
                            <div id="content">
                                <div id="title">
                                    ...
                                    <div style="display:inline-block;"><button class="btn btn-link" onclick="location.href = '/supplier_credits/{{ $supplierCredit->id }}/edit';">Edit</button></div>
                                    <div style="display:inline-block;"><form method="POST" action="/supplier_credits/{{ $supplierCredit->id }}">
                                        @csrf
                                        @method('DELETE')
