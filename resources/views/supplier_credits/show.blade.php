                ...
                <div id="wrapper">
                    <div id="page" class="container">
                        <div class="content">
                            ...
                            @endif
                            <form method="POST" action="/supplier_credits/{{ $supplierCredit->id }}">
                                @csrf
                                @method('PUT')
                                @if ($errors->any())
                            ...
                            <div style="float: right; clear: both;">
                                <div style="display: inline-block;">
                                    <button class="btn btn-primary" onclick="location.href = '/supplier_credits/{{ $supplierCredit->id }}/edit';">Edit</button>
                                </div>
                                <div style="display: inline-block;">
                                    <form method="POST" action="/supplier_credits/{{ $supplierCredit->id }}">
                                        @csrf
