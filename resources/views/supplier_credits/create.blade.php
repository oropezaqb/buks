...
@section('content')
    <div class="col-md-12">
        <div class="card">
            <div class="card-header font-weight-bold">Company: {{ \Auth::user()->currentCompany->company->name }} (Add a New Supplier Credit)</div>
            <div class="card-body">
                <div id="wrapper">
                    <div id="page" class="container">
                        <div class="content">
                            ...
                            @endif
                            <form method="POST" action="/supplier_credits">
                                @csrf
                                @if ($errors->any())
                                ...
                                <div class="form-group custom-control-inline">
                                    ...
                                    <input list="purchasable_docs" id="purchasable_doc0" onchange="setValue(this)" data-id="" class="custom-select @error('purchasable_doc') is-danger @enderror" required value="{!! old('purchasable_doc') !!}">
                                    <datalist id="purchasable_docs">
                                        <option data-value="Bill">Bill</option>
                                        <option data-value="Cheque">Cheque</option>
                                    </datalist>
                                    <input type="hidden" name="purchasable_doc" id="purchasable_doc0-hidden" value="{!! old('purchasable_doc') !!}">
                                    <input type="hidden" name="purchasable_doc" id="name-purchasable_doc0-hidden" value="{!! old('purchasable_doc') !!}">
                                </div>
                                <div class="form-group custom-control-inline">
